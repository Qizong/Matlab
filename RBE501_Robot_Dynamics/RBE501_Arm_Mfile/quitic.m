...
% -----------------------------------------------------
% Title:    quintic
%           [Compute the Quintic Polynomial trajectory for a joint variable]
% -----------------------------------------------------
...
%
% Outputs:  X = Quintic Coefficients
% -----------------------------------------------------
% Useage: X=quintic(0,10,0,1,-20,0)
% -----------------------------------------------------
function X=quintic(t0,q0,v0,tf,qf,vf)
